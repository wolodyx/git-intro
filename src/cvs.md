...
Git -- это наиболее популярная система контроля версий (далее СКВ), используемая разработчиками и не только.
Она также является ключевым элементом сервиса GitHub.
...
Слово "система" в названии говорит, что понимание Git шире, чем просто набор программных инструментов.
Она представляет технологию, включающая в себя разные способы использования этих инструментов.
С ее помощью на практике можно организовать эффективный рабочий процесс в не зависимости от размера команды, удаленности участников, активности работы.
