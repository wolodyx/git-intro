...
1. Перечислите основные этапы развития СКВ в правильном порядке.
1. Чем характеризуются разные типы СКВ?
1. Какие из СКВ относятся к локальным, централизованным и децентрализованным?
1. В каких СКВ риск потерять хранилище выше?
1. Какие СКВ привязывают своих клиентов к внешним ресурсам?
