...
Состояние файловой системы в рабочем каталоге претерпевает следующие изменения:
* добавление файла;
* удаление файла;
...
Файл с точки зрения файловой системы состоит из двух частей: содержимого и метаданных.
Метаданные представлены именем и атрибутами файла.
...
Команда `git diff` (без аргументов) сравнивает измененные файлы в рабочей копии с зафиксированными и отображает патч на экране терминала.
