...
Первый модуль вводит в основы Git.
...
В конце каждого урока присутствуют разделы "Контрольные вопросы" и "Упражнения".
Первые фиксируют новоприобретенные знания, а вторые формируют навыки.
Рекомендуется пройти их.

<!-- Про виртуальную машину -->
...
* [Get started with GitHub documentation](https://docs.github.com/en/get-started), разделы "Git basics" и "Using Git".
