...
Для решения этой проблемы, редактор "Microsoft Word" предлагает режим правок, при включении которого последующие редактирования текста выделяются визуально, одновременно сохраняя исходные состояния.
...
Следующий недостаток при совместной работе над документом состоит в том, что автору не доступна информация о том, кто, когда, что и зачем предложил изменить.
...
Проблемы, возникающие при коллективной работе над разработкой ПО, как раз и решает Git.
...
Система контроля версий решает недостатки, свойственные совместной работе нескольких участников над проектом.
Она:
